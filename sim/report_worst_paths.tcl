...
# the aggregate slack/TNS numbers in Arcade-Z80-3D.sta.summary.
#
# Run from the project directory (where Arcade-Z80-3D.qpf lives), against an
# already-compiled project (uses the existing db/ from the last full compile
# -- does not re-run the fitter):
#
#   quartus_sta Arcade-Z80-3D -t sim/report_worst_paths.tcl
#
# Output: output_files/worst_paths.rpt

project_open Arcade-Z80-3D
